...
TGEMSBSBox::TGEMSBSBox (Double_t dmag, Double_t d0, Double_t xoffset, 
...
Bool_t
TGEMSBSBox::Contains (Double_t x, Double_t y) const
{
...
Bool_t
TGEMSBSBox::Contains (Double_t x, Double_t y, Double_t z) const
{
...
void
TGEMSBSBox::SetGeometry (const Double_t dmag,
		      const Double_t d0,
...
void
TGEMSBSBox::HallCenterToBox (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
...
void
TGEMSBSBox::HallCenterToSpec (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
...
void
TGEMSBSBox::LabToBox (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
  LabToSpec(x, y, z);
  z = z-fD0*1.0e3;
  SpecToBox(x, y);
...
void
TGEMSBSBox::HallCenterToLab (Double_t& /*x*/, Double_t& /*y*/, Double_t& /*z*/) const  // input and output in mm!!!
{
...
void
TGEMSBSBox::LabToSpec (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
...
void
TGEMSBSBox::SpecToBox (Double_t& x, Double_t& /*y*/) const  // input and output in mm!!!
{
  x = x-fXOffset*1.0e3;
  //neutral for y
...
void
TGEMSBSBox::BoxToSpec (Double_t& x, Double_t& /*y*/) const  // input and output in mm!!!
{
  x = x+fXOffset*1.0e3;
  //neutral for y
  return;
...
void
TGEMSBSBox::SpecToLab (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
  Double_t r_temp[3] = {x, y, z};
  TMatrixD m_temp(3, 1, r_temp);
...
void
TGEMSBSBox::LabToHallCenter (Double_t& /*x*/, Double_t& /*y*/, Double_t& /*z*/) const  // input and output in mm!!!
{
  //TODO ? if possible: reprogram this, but using the spectrometer angle
  //x = x - fDMag*sin(fThetaH)*1.0e3;
  // neutral in y
...
void
TGEMSBSBox::BoxToLab (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
  BoxToSpec(x, y);
  z = z + fD0*1.0e3;
  SpecToLab(x, y, z);
...
void
TGEMSBSBox::SpecToHallCenter (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
...
void
TGEMSBSBox::BoxToHallCenter (Double_t& x, Double_t& y, Double_t& z) const  // input and output in mm!!!
{
  BoxToLab(x, y, z);
  LabToHallCenter(x, y, z);
  return;
